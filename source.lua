...
local isSuc, info = pcall(market.GetProductInfo,market,game.PlaceId)
    ...
    do
        local Window = library:AddWindow("UpHub+", {
            main_color = Color3.fromRGB(231, 119, 97),
        ...
        local Games = Window:AddTab("Games")
        local GameTP = Window:AddTab("Game TP")
        local Others = Window:AddTab("Others")
        local Credits = Window:AddTab("Credits")

        local tkey = Enum.KeyCode.Insert
        ...
        local ScriptPage1 = Scripts:AddFolder("Page 1")
           ...
           ScriptPage2:AddButton("Infinite Store", function()
            ...
            GamePage2:AddButton("Work At a Pizza Place", function()
            ...
            GamePage2:AddButton("Bloodfest", function() --48994649
            ...
            GamePage3:AddButton("YouTube Simulator", function()
                loadstring(game:HttpGet("https://paste.c-net.org/BabetteClouded", true))()
            end)
            ...
            GamePage3:AddButton("Tower of Hell", function()
                loadstring(game:HttpGet("https://raw.githubusercontent.com/insanedude59/CheetoHub/main/1962086868",true))()
            end)
            ...
            GameTpPage1:AddButton("CB:RO", function()
                game:GetService('TeleportService'):Teleport(301549746)
            end)
            GameTpPage1:AddButton("Jailbreak", function()
                game:GetService('TeleportService'):Teleport(606849621)
            end)
            GameTpPage1:AddButton("MM2", function()
                game:GetService('TeleportService'):Teleport(142823291)
            end)
            GameTpPage1:AddButton("Prison Life", function()
                game:GetService('TeleportService'):Teleport(155615604)
            end)
            GameTpPage1:AddButton("KAT", function()
            ...
            GameTpPage1:AddButton("The Wild West", function()
                game:GetService('TeleportService'):Teleport(2317712696)
            end)
            GameTpPage1:AddButton("Bedwars", function()
                game:GetService('TeleportService'):Teleport(6872265039)
            end)
            GameTpPage1:AddButton("Piggy", function()
                game:GetService('TeleportService'):Teleport(4623386862)
            end)
            ...
            GameTpPage2:AddButton("Work At a Pizza Place", function()
                game:GetService('TeleportService'):Teleport(192800)
            end)
            GameTpPage2:AddButton("Bloodfest", function()
                game:GetService('TeleportService'):Teleport(48994649)
            end)

            GameTpPage2:AddButton("Electric State", function()
            ...
            GameTpPage2:AddButton("YouTube Simulator", function()
                game:GetService('TeleportService'):Teleport(6859865958)
            end)

            GameTpPage2:AddButton("Anomic", function()
                game:GetService('TeleportService'):Teleport(4581966615)
            end)
            ...
            --Others
            Others:AddLabel("v3.2.1+ reb.")
            Others:AddLabel(info.Name)
            

            local Executor = Others:AddFolder("Executor")

            local Console = Executor:AddConsole({
                ["y"] = 200,
                ["source"] = "Lua",
            })
            Console:Set("--Executor :] \nfor i = 1, 9 do \n    print(i)\nend")

            local HA = Executor:AddHorizontalAlignment()
            ...
            Others:AddButton("Discord Server Link", function()
